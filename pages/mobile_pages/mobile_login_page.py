...
class MobileLoginPage:
    ...
    def load_login_page(self):
        ...
        try:
            self.mobile_page.locator(self.NOTIFICATION_POP_UP).wait_for(
                state="visible"
            )
    ...
    def login_status(self, name: str) -> bool:
        ...
        self.mobile_page.locator(LOGGED_IN_USER_NAME).wait_for(
            state="visible"
        )

        logged_in_user_name = self.mobile_page.locator(
            LOGGED_IN_USER_NAME
        )
